...
- (NSArray *)recognize:(NSArray *)points {
...
- (void)addGesture:(NSString *)name
    ...
    if (array) {
        ...
        [mutableArray addObject:[NSKeyedArchiver archivedDataWithRootObject:pointCloud]];
        [dic setValue:[mutableArray copy] forKey:name];
    } else {
        [dic setValue:@[[NSKeyedArchiver archivedDataWithRootObject:pointCloud]] forKey:name];
    }
    [defaults setObject:dic forKey:@"emoji3"];
